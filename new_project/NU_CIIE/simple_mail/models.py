...
class SimpleMailConfig(SingletonModel):
    ...
    # Header
    logo = models.ImageField(verbose_name=_("Logo"), upload_to="images",default='', null=True)
    # footer
...
class SimpleMail(models.Model):
    ...
    banner = models.ImageField(verbose_name=_("Banner"), upload_to="simple_mail/media", blank=True, null=True)
  ...
  #  @property
   # def banner_url(self):
    ...
    def render(self, context={}, template=None):
        ...
        config_context['banner_url'] = self.resized_banner
